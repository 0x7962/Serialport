...
package com.rpdzkj.yangbin.serialport;
                ...
                synchronized (mByteReceivedBackSemaphore) {
                    ...
                    try {
                        ...
                        runOnUiThread(new Runnable() {
                            public void run() {
                                mTextViewOutgoing.setText(mOutgoing + "");
                                mTextViewLost.setText(mLost + "");
                                mTextViewIncoming.setText(mIncoming + "");
                                mTextViewCorrupted.setText(mCorrupted + "");
                            }
                        });
